      ...
      <div className="px-5 py-6 space-y-6">
        ...
        <div className="bg-white rounded-2xl p-5 shadow-sm border border-slate-100">
          <div className="flex justify-between items-center mb-4">
            ...
            <Link href="/jamaah-app/jadwal" className="text-xs font-bold text-emerald-600 flex items-center">
        ...
        <div className="bg-slate-900 rounded-2xl p-5 shadow-lg text-white relative overflow-hidden mb-8">
